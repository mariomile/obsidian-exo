...
| 25 | Command IDs don't duplicate the plugin ID prefix | **N-A / not verified in this pass** | Not in scope of this brief's diff; commands are prefixed automatically by Obsidian regardless — flagged as a nice-to-have spot check, not a blocker |
