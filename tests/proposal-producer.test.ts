...
describe("proposal producer eligibility", () => {
  const gates: Array<[string, Partial<ProposalTurnInput>, string]> = [
    ...
    ["pending ask", { hasPendingAsk: true }, "pending_interaction"],
    ["pending permission", { hasPendingPermission: true }, "pending_interaction"],
    ["pending plan", { hasPendingPlan: true }, "pending_interaction"],
